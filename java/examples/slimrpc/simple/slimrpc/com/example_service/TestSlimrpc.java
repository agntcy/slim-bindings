...
public final class TestSlimrpc {
    ...
    public static final class TestGroupClientImpl implements TestGroupClient {
        private final Channel channel;

        public TestGroupClientImpl(Channel channel) {
            this.channel = channel;
        }

        @Override
        public MulticastResponseStream<ExampleResponse> ExampleUnaryUnary(ExampleRequest request, Duration timeout, Map<String, String> metadata) throws RpcException {
            ...
            return new MulticastResponseStream<>(reader, bytes -> parse(bytes, ExampleResponse.parser()));
        }

        @Override
        public MulticastResponseStream<ExampleResponse> ExampleUnaryStream(ExampleRequest request, Duration timeout, Map<String, String> metadata) throws RpcException {
        ...
        @Override
        public MulticastClientBidiStream<ExampleRequest, ExampleResponse> ExampleStreamUnary(Duration timeout, Map<String, String> metadata) throws RpcException {
            ...
            return new MulticastClientBidiStream<>(handler, ExampleRequest::toByteArray, bytes -> parse(bytes, ExampleResponse.parser()));
        }

        @Override
        public MulticastClientBidiStream<ExampleRequest, ExampleResponse> ExampleStreamStream(Duration timeout, Map<String, String> metadata) throws RpcException {
